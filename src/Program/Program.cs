...
namespace Program
{
     class Program
    {
            ...
            public static void Main(string[] args)
        {
            ...
            ElementoMagico BastonMagico = new ElementoMagico("bastón magico", 3, 60);
            LibroHechiozos Libro = new LibroHechiozos("ponzoña", 30);
            ...
            Gandalf.Atacar(Legolas, BastonMagico, Libro);
